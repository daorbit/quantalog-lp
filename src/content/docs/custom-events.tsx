...
function Body() {
  return (
    <>
      <P>
        Custom events turn any action into a tracked metric â€” a signup, a
...
window.rta.track("checkout_started", { plan: "pro", value: 49 });`}</Pre>
      ...
      <P>
        ...
        properties object of extra context â€” a plan tier, an order value, anything
      ...
      <P>
        ...
        count, distinct visitors, and conversion rate â€” the share of visitors in
      ...
      <P>
        ...
        into revenue â€” per event and across all events for the period. This turns
