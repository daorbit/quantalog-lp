  ...
  return (
    <>
      <P>
        ...
        site — outbound links to other domains, and clicks that download a file —
      ...
      <Ul>
        <Li>
          <b>Outbound</b> — a click on an <Code>&lt;a&gt;</Code> whose host differs
          from your own.
        </Li>
        <Li>
          <b>Downloads</b> — a link to a file: pdf, zip, csv, xlsx, mp4, dmg, and
          other common document, archive, and media types.
        </Li>
      </Ul>
      <P>
        Both are grouped by destination and shown under <b>Analytics → Clicks</b>,
      ...
      <Callout>
        ...
        working — they just won&apos;t report outbound clicks until the snippet is
        updated.
      </Callout>
    </>
  );
