  ...
  return (
    <form onSubmit={onSubmit} noValidate className="card p-7 sm:p-8">
      ...
      <button
        ...
        className="group mt-7 inline-flex w-full items-center justify-center gap-2 whitespace-nowrap rounded-lg bg-cta px-5 py-2.5 text-sm font-semibold text-cta-fg shadow-soft transition duration-200 hover:bg-cta-hover disabled:cursor-not-allowed disabled:opacity-60"
      >
        {state === "sending" ? (
          <>
